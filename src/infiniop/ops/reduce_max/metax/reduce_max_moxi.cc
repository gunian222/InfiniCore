#include "reduce_max_moxi.h"
#include "../../../device/moxi/handle.h"
...
infiniStatus_t Descriptor::create(
    ...
    auto handle = reinterpret_cast<device::moxi::Handle *>(handle_);
...
infiniStatus_t Descriptor::calculate(
    ...
    case INFINI_DTYPE_F16:
        return reduce::moxi::launch_kernel<ReduceMaxOp, mxi_half>(
            _handle,
            ReduceMaxOp(),
            output,
            input,
    ...
    case INFINI_DTYPE_F32:
        return reduce::moxi::launch_kernel<ReduceMaxOp, float>(
            _handle,
            ReduceMaxOp(),
            output,
            input,
...
size_t Descriptor::workspaceSize() const {
    return reduce::moxi::get_workspace_size<ReduceMaxOp>(
        _input_desc->shape(),
        _output_desc->shape(),
        _dtype,
        _axes);
